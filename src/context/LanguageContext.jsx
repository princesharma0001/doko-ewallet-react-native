...
const translations = {
  en: {
    ...
    wouldLikeToEnterWithFaceId: 'Would you like to enter the application with Face ID',
    deviceNotSupportBiometric: "Your device doesn't support biometric authentication.",
    pleaseSetupBiometricInSettings: 'Please set up {biometricName} in Settings first.',
    ...
    pleaseSetupBiometricFirst: 'Please set up Face ID/Touch ID in your device settings first.',
    cancel: 'Cancel',
    settings: 'Settings',
    goToSettings: 'Please go to Settings > Face ID & Passcode to set up Face ID.',
    faceIdEnabled: 'Face ID Enabled',
    faceIdEnabledSuccessfully: 'Face ID has been successfully enabled for your account!',
    continue: 'Continue',
    cancelled: 'Cancelled',
    ...
    authenticationFailed: 'Authentication Failed',
    faceIdAuthenticationFailed: 'Face ID authentication failed. Please try again.',
    skipFaceId: 'Skip Face ID',
    skipFaceIdConfirmation: 'Are you sure you want to skip Face ID setup? You can enable it later in settings.',
    skip: 'Skip',
    faceId: 'Face ID',
    touchId: 'Touch ID',
    biometric: 'Biometric',
    ...
    profileUpdatedSuccessfully: 'Profile updated successfully!',
    failedToUpdateProfile: 'Failed to update profile. Please try again.',
    yourInformationSaved: 'Your Information has been saved and submitted to regulators, if you would like to update this information let us know',
    ...
    weAreSorryToSeeYouGo: "We're sorry to see you go! Please let us know why you're cancelling your subscription:",
    ...
    marketingOffersDescription: "I accept to recieve emails about DOKO's services and products that may benefit me in the future.",
    transactions: 'Transactions',
    transactionsDescription: 'I accept to receive notifications regarding all transactions.',
    investmentNews: 'Investment News',
    investmentNewsDescription: 'I accept to receive emails and in-app notifications of investment.',
    ...
    anUnexpectedErrorOccurred: 'An unexpected error occurred. Please try again.',
    ...
    letYourFriendsDownloadTheApp: 'Let your friends download the app from the app store',
    pressOnTheLinkProvided: 'Press On The Link Provided by you to them after downloading the app',
    ...
    letYourFriendsDownloadTheAppFromAppStore: 'Let your friends download the app form the app store',
    pressOnTheLinkProvidedByYou: 'Press On The Link Provided by you to them after downloading the app',
    letThemVerifyTheirAccount: 'Let them verify their account',
    convinceThemToSubscribeToDoko: 'Convince them to subscribe to DOKO',
    makeThemCompleteTheirPaymentOfSubscription: 'Make them complete their payment of subscription',
    
    // DeleteAccountConfirmationModal
    deleteAccount: 'Delete Account',
    areYouSureYouWantToDeleteYourAccount: 'Are you sure you want to delete your account? This action cannot be undone and all your data will be permanently removed.',
    thisWillPermanentlyDeleteAllYourData: 'This will permanently delete all your data, transactions, and account information.',
    cancel: 'Cancel',
    deleting: 'Deleting...',
    ...
    selectChannelFromListOrCreateNew: 'Select a channel from the list or create a new one to start chatting.',
    createChannel: 'Create Channel',
    guide: 'Guide',
    suggested: 'Suggested',
    tips: 'Tips',
    selectAChannel: 'Select a Channel',
    chooseFromExistingChannels: 'Choose from existing channels in the sidebar to join conversations on specific topics.',
    createANewChannel: 'Create a New Channel',
    ifYouCantFindWhatYoureLookingFor: "If you can't find what you're looking for, create a new channel to start a fresh discussion.",
    participateInDiscussions: 'Participate in Discussions',
    onceYouveJoinedAChannel: 'Once you\'ve joined a channel, you can send messages, share files, and engage with other community members.',
    suggestedChannels: 'Suggested Channels',
    discoverPopularChannels: 'Discover popular channels and communities that might interest you.',
    communityTips: 'Community Tips',
    learnBestPractices: 'Learn best practices for engaging with the community and making the most of your experience.',
    ...
    thisIsTwelveMonthPlan: 'This is a 12 month plan. By proceeding, you agree to the',
    ...
    youNeedToDepositMoney: 'You need to deposit money to your account to subscribe :)',
    ...
    yourSubscriptionHasBeenActivated: 'Your subscription has been successfully activated!',
    
    // DAppSection
    dAppBrowser: 'dApp Browser',
    browseAndInteract: 'Browse and interact with decentralized applications directly from the platform.',
    search: 'Search',
    all: 'All',
    defi: 'DeFi',
    nfts: 'NFTs',
    ...
    addCustomDAppDescription: 'This feature will allow you to add custom dApps to your browser.',
    ok: 'OK',
    ...
    exportDescription: 'Your transaction data has been formatted and is ready to share. You can share it via email, messaging apps, or save it to your device.',
    ...
    anErrorOccurredWhileLoading: 'An error occurred while loading notifications',
    ...
    fromDateAfterToDate: 'From date is after to date. To date has been cleared.',
    invalidDateRange: 'Invalid Date Range',
    toDateBeforeFromDate: 'To date cannot be before from date. Please select a valid date.',
    fromDateAfterToDateInvalid: 'From date cannot be after to date. Please select valid dates.',
    ...
    authenticationRequired: 'Authentication required',
    failedToFetchTransactions: 'Failed to fetch transactions',
    anErrorOccurredWhileFetching: 'An error occurred while fetching transactions',
    ...
    sendMoneyByScanning: 'Send money by scanning a QR code or receive money by showing your QR code',
    ...
    scanned: 'Scanned',
    thisDoesntAppearToBeDokoPaymentQrCode: 'This doesn\'t appear to be a DOKO payment QR code.',
    tryAgain: 'Try Again',
    cancel: 'Cancel',
    invalidQrCode: 'Invalid QR Code',
    thisQrCodeIsNotValidDokoPaymentCode: 'This QR code is not a valid DOKO payment code. Please scan a DOKO QR code.',
    failedToProcessQrCode: 'Failed to process QR code. Please try again.',
    permissionRequired: 'Permission Required',
    cameraPermissionIsRequiredToScanQrCodes: 'Camera permission is required to scan QR codes. Please enable it in your device settings.',
    openSettings: 'Open Settings',
    permission: 'Permission',
    cameraPermissionIsRequiredToScanQrCodesShort: 'Camera permission is required to scan QR codes',
    error: 'Error',
    ...
    scanThisQrCodeToSendMeMoneyViaDoko: 'Scan this QR code to send me money via DOKO!',
    user: 'User',
    ...
    thisAppNeedsAccessToYourContacts: 'This app needs access to your contacts to show them in the app.',
    askMeLater: 'Ask Me Later',
    cancel: 'Cancel',
    ok: 'OK',
    permissionRequired: 'Permission Required',
    thisAppNeedsAccessToYourContactsToShowThem: 'This app needs access to your contacts to show them. Please grant permission in Settings > Privacy & Security > Contacts.',
    openSettings: 'Open Settings',
    error: 'Error',
    failedToFetchContacts: 'Failed to fetch contacts',
    noContacts: 'No Contacts',
    noContactsFoundOnYourDevicePleaseAddSome: 'No contacts found on your device. Please add some contacts to your phone first.',
    success: 'Success',
  ...
  ne: {
    ...
    enterVerificationCodeSent: 'कृपया पठाइएको ४-अंकीय प्रमाणीकरण कोड प्रविष्ट गर्नुहोस्',
    pleaseEnterVerificationCode: 'कृपया ४-अंकीय प्रमाणीकरण कोड प्रविष्ट गर्नुहोस्',
    ...
    failedToCreatePasscode: 'पासकोड सिर्जना गर्न असफल। कृपया फेरि प्रयास गर्नुहोस्।',
    
    // FaceID
    enterWithFaceId: 'Face ID सँग प्रविष्ट गर्नुहोस्?',
    wouldLikeToEnterWithFaceId: 'के तपाईं Face ID सँग अनुप्रयोगमा प्रविष्ट हुन चाहनुहुन्छ',
    deviceNotSupportBiometric: 'तपाईंको उपकरणले बायोमेट्रिक प्रमाणीकरण समर्थन गर्दैन।',
    pleaseSetupBiometricInSettings: 'कृपया पहिले सेटिङमा {biometricName} सेटअप गर्नुहोस्।',
    ...
    pleaseSetupBiometricFirst: 'कृपया पहिले आफ्नो उपकरण सेटिङमा Face ID/Touch ID सेटअप गर्नुहोस्।',
    cancel: 'रद्द गर्नुहोस्',
    settings: 'सेटिङ',
    goToSettings: 'कृपया Face ID सेटअप गर्न सेटिङ > Face ID & Passcode मा जानुहोस्।',
    faceIdEnabled: 'Face ID सक्षम भयो',
    faceIdEnabledSuccessfully: 'तपाईंको खाताका लागि Face ID सफलतापूर्वक सक्षम भयो!',
    continue: 'जारी राख्नुहोस्',
    cancelled: 'रद्द भयो',
    ...
    authenticationFailed: 'प्रमाणीकरण असफल',
    faceIdAuthenticationFailed: 'Face ID प्रमाणीकरण असफल भयो। कृपया फेरि प्रयास गर्नुहोस्।',
    skipFaceId: 'Face ID छोड्नुहोस्',
    skipFaceIdConfirmation: 'के तपाईं Face ID सेटअप छोड्न चाहनुहुन्छ? तपाईंले यसलाई पछि सेटिङमा सक्षम गर्न सक्नुहुन्छ।',
    skip: 'छोड्नुहोस्',
    faceId: 'Face ID',
    touchId: 'Touch ID',
    ...
    authenticationTokenNotFound: 'प्रमाणीकरण टोकन फेला परेन। कृपया फेरि लगइन गर्नुहोस्।',
    ...
    unexpectedErrorOccurred: 'अप्रत्याशित त्रुटि भयो। कृपया फेरि प्रयास गर्नुहोस्।',
    ...
    usernameInvalid: 'प्रयोगकर्ता नाम ३-२० अक्षरको, अक्षर, संख्या र अण्डरस्कोर मात्र हुनुपर्छ',
    emailRequired: 'इमेल आवश्यक छ',
    ...
    profileUpdatedSuccessfully: 'प्रोफाइल सफलतापूर्वक अपडेट भयो!',
    failedToUpdateProfile: 'प्रोफाइल अपडेट गर्न असफल। कृपया फेरि प्रयास गर्नुहोस्।',
    yourInformationSaved: 'तपाईंको जानकारी सेभ भएको छ र नियामकहरूलाई पेश गरिएको छ, यदि तपाईं यो जानकारी अपडेट गर्न चाहनुहुन्छ भने हामीलाई थाहा दिनुहोस्',
    ...
    weAreSorryToSeeYouGo: 'हामीलाई तपाईंले जानुहुन्छ भन्ने दुःख लाग्यो! कृपया तपाईंले आफ्नो सदस्यता किन रद्द गर्दै हुनुहुन्छ भन्ने कारण बताउनुहोस्:',
    ...
    marketingOffersDescription: 'म भविष्यमा मलाई फाइदा हुन सक्ने DOKO का सेवाहरू र उत्पादहरूको बारेमा इमेल प्राप्त गर्न स्वीकार गर्छु।',
    transactions: 'लेनदेनहरू',
    transactionsDescription: 'सबै लेनदेनहरूको बारेमा सूचना प्राप्त गर्न म स्वीकार गर्छु।',
    investmentNews: 'लगानी समाचार',
    investmentNewsDescription: 'लगानीको बारेमा इमेल र इन-एप सूचनाहरू प्राप्त गर्न म स्वीकार गर्छु।',
    loadingSettings: 'सेटिङहरू लोड गर्दै...',
    settings: 'सेटिङ',
    failedToLoadNotificationSettings: 'सूचना सेटिङहरू लोड गर्न असफल',
    notification: 'सूचना',
    authenticationTokenNotFound: 'प्रमाणीकरण टोकन फेला परेन। कृपया फेरि लगइन गर्नुहोस्।',
    anUnexpectedErrorOccurred: 'अप्रत्याशित त्रुटि भयो। कृपया फेरि प्रयास गर्नुहोस्।',
    ...
    letYourFriendsDownloadTheApp: 'तपाईंका साथीहरूलाई एप स्टोरबाट एप डाउनलोड गर्न दिनुहोस्',
    pressOnTheLinkProvided: 'एप डाउनलोड गरेपछि तपाईंले दिनुभएको लिङ्कमा थिच्नुहोस्',
    letThemVerifyTheirAccount: 'उनीहरूलाई आफ्नो खाता प्रमाणित गर्न दिनुहोस्',
    convinceThemToSubscribeToDoko: 'उनीहरूलाई DOKO मा सदस्यता लिन प्रेरित गर्नुहोस्',
    ...
    letYourFriendsDownloadTheAppFromAppStore: 'तपाईंका साथीहरूलाई एप स्टोरबाट एप डाउनलोड गर्न दिनुहोस्',
    pressOnTheLinkProvidedByYou: 'एप डाउनलोड गरेपछि तपाईंले दिनुभएको लिङ्कमा थिच्नुहोस्',
    letThemVerifyTheirAccount: 'उनीहरूलाई आफ्नो खाता प्रमाणित गर्न दिनुहोस्',
    convinceThemToSubscribeToDoko: 'उनीहरूलाई DOKO मा सदस्यता लिन प्रेरित गर्नुहोस्',
    makeThemCompleteTheirPaymentOfSubscription: 'उनीहरूलाई सदस्यताको भुक्तानी पूरा गर्न दिनुहोस्',
    
    // DeleteAccountConfirmationModal
    deleteAccount: 'खाता मेटाउनुहोस्',
    areYouSureYouWantToDeleteYourAccount: 'के तपाईं आफ्नो खाता मेटाउन चाहनुहुन्छ? यो कार्य फिर्ता गर्न मिल्दैन र तपाईंको सबै डाटा स्थायी रूपमा हटाइनेछ।',
    thisWillPermanentlyDeleteAllYourData: 'यसले तपाईंको सबै डाटा, लेनदेनहरू, र खाता जानकारी स्थायी रूपमा मेटाउनेछ।',
    cancel: 'रद्द गर्नुहोस्',
    deleting: 'मेटाउँदै...',
    ...
    selectChannelFromListOrCreateNew: 'च्याटिङ सुरु गर्नको लागि सूचीबाट च्यानल छान्नुहोस् वा नयाँ बनाउनुहोस्।',
    createChannel: 'च्यानल बनाउनुहोस्',
    guide: 'गाइड',
    suggested: 'सुझाव',
    tips: 'सुझावहरू',
    selectAChannel: 'च्यानल छान्नुहोस्',
    chooseFromExistingChannels: 'विशिष्ट विषयहरूमा कुराकानीमा सामेल हुनको लागि साइडबारमा रहेका मौजूदा च्यानलहरूबाट छान्नुहोस्।',
    createANewChannel: 'नयाँ च्यानल बनाउनुहोस्',
    ifYouCantFindWhatYoureLookingFor: 'यदि तपाईंले खोजिरहेको कुरा फेला परेन भने, नयाँ चर्चा सुरु गर्नको लागि नयाँ च्यानल बनाउनुहोस्।',
    participateInDiscussions: 'चर्चाहरूमा सहभागी हुनुहोस्',
    onceYouveJoinedAChannel: 'एकपटक तपाईंले च्यानलमा सामेल भएपछि, तपाईंले सन्देश पठाउन, फाइलहरू साझा गर्न, र अन्य समुदाय सदस्यहरूसँग जोडिन सक्नुहुन्छ।',
    suggestedChannels: 'सुझावित च्यानलहरू',
    discoverPopularChannels: 'तपाईंलाई रुचि हुन सक्ने लोकप्रिय च्यानलहरू र समुदायहरू खोज्नुहोस्।',
    communityTips: 'समुदाय सुझावहरू',
    learnBestPractices: 'समुदायसँग जोडिन र तपाईंको अनुभवलाई अधिकतम बनाउनको लागि उत्तम अभ्यासहरू सिक्नुहोस्।',
    ...
    thisIsTwelveMonthPlan: 'यो १२ महिनाको योजना हो। अगाडि बढ्दै, तपाईंले यसलाई स्वीकार गर्नुहुन्छ',
    ...
    youNeedToDepositMoney: 'तपाईंले सदस्यता लिनको लागि आफ्नो खातामा पैसा जम्मा गर्नुपर्छ :)',
    ...
    browseAndInteract: 'प्लेटफर्मबाट सिधै विकेन्द्रीकृत अनुप्रयोगहरू ब्राउज गर्नुहोस् र काम गर्नुहोस्।',
    search: 'खोज्नुहोस्',
    all: 'सबै',
    defi: 'DeFi',
    nfts: 'NFTs',
    ...
    addCustomDAppDescription: 'यो सुविधाले तपाईंलाई आफ्नो ब्राउजरमा कस्टम dAppहरू थप्न अनुमति दिनेछ।',
    ok: 'ठीक छ',
    ...
    exportDescription: 'तपाईंको लेनदेन डेटा फरमेट गरिएको छ र साझा गर्न तयार छ। तपाईंले यसलाई इमेल, मेसेजिङ एपहरू मार्फत साझा गर्न सक्नुहुन्छ वा आफ्नो डिभाइसमा सेभ गर्न सक्नुहुन्छ।',
    ...
    errorLoadingNotifications: 'सूचनाहरू लोड गर्दा त्रुटि',
    ...
    fromDateAfterToDate: 'सुरुको मिति अन्तिम मिति भन्दा पछि छ। अन्तिम मिति खाली गरिएको छ।',
    invalidDateRange: 'अवैध मिति दायरा',
    toDateBeforeFromDate: 'अन्तिम मिति सुरुको मिति भन्दा अगाडि हुन सक्दैन। कृपया वैध मिति छान्नुहोस्।',
    fromDateAfterToDateInvalid: 'सुरुको मिति अन्तिम मिति भन्दा पछि हुन सक्दैन। कृपया वैध मितिहरू छान्नुहोस्।',
    filterError: 'फिल्टर त्रुटि',
    failedToApplyDateFilter: 'मिति फिल्टर लागू गर्न असफल। कृपया पुनः प्रयास गर्नुहोस्।',
    failedToClearFilters: 'फिल्टरहरू खाली गर्न असफल। कृपया पुनः प्रयास गर्नुहोस्।',
    sentTo: 'पठाइएको',
    ...
    pleaseEnterCompleteCardDetails: 'कृपया पूर्ण कार्ड विवरणहरू प्रविष्ट गर्नुहोस्',
    ...
    sendMoneyByScanning: 'QR कोड स्क्यान गरेर पैसा पठाउनुहोस् वा आफ्नो QR कोड देखाएर पैसा प्राप्त गर्नुहोस्',
    ...
    showThisQrCodeToReceiveMoney: 'पैसा प्राप्त गर्नको लागि यो QR कोड देखाउनुहोस्',
    ...
    thisDoesntAppearToBeDokoPaymentQrCode: 'यो DOKO भुक्तानी QR कोड जस्तो देखिँदैन।',
    tryAgain: 'फेरि प्रयास गर्नुहोस्',
    cancel: 'रद्द गर्नुहोस्',
    invalidQrCode: 'अवैध QR कोड',
    thisQrCodeIsNotValidDokoPaymentCode: 'यो QR कोड वैध DOKO भुक्तानी कोड होइन। कृपया DOKO QR कोड स्क्यान गर्नुहोस्।',
    failedToProcessQrCode: 'QR कोड प्रक्रिया गर्न असफल। कृपया फेरि प्रयास गर्नुहोस्।',
    permissionRequired: 'अनुमति आवश्यक',
    cameraPermissionIsRequiredToScanQrCodes: 'QR कोडहरू स्क्यान गर्न क्यामेरा अनुमति आवश्यक छ। कृपया यसलाई तपाईंको उपकरण सेटिङमा सक्षम गर्नुहोस्।',
    openSettings: 'सेटिङ खोल्नुहोस्',
    permission: 'अनुमति',
    cameraPermissionIsRequiredToScanQrCodesShort: 'QR कोडहरू स्क्यान गर्न क्यामेरा अनुमति आवश्यक छ',
    error: 'त्रुटि',
    ...
    downloadDokoAppToSendMoneyEasily: 'पैसा सजिलैसँग पठाउनको लागि DOKO एप डाउनलोड गर्नुहोस्!',
    ...
    scanThisQrCodeToSendMeMoneyViaDoko: 'DOKO मार्फत मलाई पैसा पठाउनको लागि यो QR कोड स्क्यान गर्नुहोस्!',
    user: 'प्रयोगकर्ता',
    ...
    thisAppNeedsAccessToYourContacts: 'यो एपले एपमा तिनीहरूलाई देखाउनको लागि तपाईंका सम्पर्कहरूमा पहुँच चाहिन्छ।',
    askMeLater: 'पछि सोध्नुहोस्',
    cancel: 'रद्द गर्नुहोस्',
    ok: 'ठीक छ',
    permissionRequired: 'अनुमति आवश्यक',
    thisAppNeedsAccessToYourContactsToShowThem: 'यो एपले तिनीहरूलाई देखाउनको लागि तपाईंका सम्पर्कहरूमा पहुँच चाहिन्छ। कृपया सेटिङ > गोपनीयता र सुरक्षा > सम्पर्कहरूमा अनुमति दिनुहोस्।',
    openSettings: 'सेटिङ खोल्नुहोस्',
    error: 'त्रुटि',
    failedToFetchContacts: 'सम्पर्कहरू ल्याउन असफल',
    noContacts: 'सम्पर्क छैन',
    noContactsFoundOnYourDevicePleaseAddSome: 'तपाईंको उपकरणमा सम्पर्क फेला परेन। कृपया पहिले आफ्नो फोनमा केही सम्पर्कहरू थप्नुहोस्।',
    success: 'सफलता',
