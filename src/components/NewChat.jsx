...
const NewChat = ({ onBackPress, onCreateChannel }) => {
  ...
  const loadChatList = async (searchQuery = null) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        console.log("adfdgs", response.error);
  ...
  const renderChatItem = ({ item }) => {
    ...
    const participantCount =
      item.participantCount || item.participants?.length || 0;
      ...
      <View style={styles.chatItemContent}>
        <Animated.View
          style={[
            ...
            { backgroundColor: theme.colors.border, opacity: pulse },
          ]}
        />
        <View style={styles.chatDetails}>
          <Animated.View
      ...
      >
        ...
        <View
          style={[
            ...
            { backgroundColor: theme.colors.surface, gap: 5 },
          ]}
        >
          <Ionicons
            name="search"
