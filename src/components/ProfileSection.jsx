...
const ProfileSection = ({ navigation }) => {
  ...
  console.log("sdgksdjghksj", currentUser);
  ...
  const menuItems = [
    ...
    },
    {
      ...
      action: "delete",
      icon: <MaterialIcons name="delete-outline" size={20} color="#FF3B30" />,
    },
  ];
  ...
  const renderHeader = () => (
    <View style={[styles.header, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.headerContent}>
        ...
        {/* onPress={() => navigation.navigate("KYCSection")} */}
        <TouchableOpacity
          onPress={() => navigation.navigate("kycs")}
          style={[styles.proMemberButton, { backgroundColor: "#246BFD" }]}
        >
          {currentUser?.kycStatus === "NOT_SUBMITTED" ? (
            <Text style={[styles.proMemberText, { color: "#fff" }]}>
              {t("verifyIdentity")}
            </Text>
          ) : (
            <Text style={[styles.proMemberText, { color: "#fff" }]}>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() =>
                  handleMenuItemPress(item.id, item?.route, item?.action)
                }
              >
                  ...
                  <Text
                    style={[
                      styles.menuLabel,
                      {
                        ...
                        color:
                          item.id === "delete" ? "#FF3B30" : theme.colors.text,
                      },
                    ]}
                  >
                    {item.label}
